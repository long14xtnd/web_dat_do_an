                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a
                                            href="{{ URL::to('/product_by_category/' . $v_category->category_id) }}">{{ $v_category->category_name }}</a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="brands-name">
                           ...
                           $all_published_manufacture=DB::table('tbl_manufacture')
                            ...
                            foreach($all_published_manufacture as $v_manufacture){?>
                                ...
                                <li><a
                                        href="{{ URL::to('/product_by_manufacture/' . $v_manufacture->manufacture_id) }}">
            ...
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                                ...
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="{{ URL::to('frontend/images/home/Beef Masala.jpg') }}"
                                                alt="" />
                                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="{{ URL::to('frontend/images/home/Prawn Masala.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="overlay-icon">
                                            <i class="fa fa-play-circle-o"></i>
                            ...
                            <div class="col-sm-3">
                                <div class="video-gallery text-center">
                                    <a href="#">
                                        <div class="iframe-img">
                                            <img src="{{ URL::to('frontend/images/home/Beef Chili Onion1.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="overlay-icon">
                                            <i class="fa fa-play-circle-o"></i>
                        ...
                        <div class="col-sm-3">
                            <div class="address">
                                <img src="{{ URL::to('frontend/images/home/Beef Chili Onion.jpg') }}"
                                    alt="" />
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="pull-right">Designed by <span><a target="_blank" href="#">Imran</a></span>
                        </p>
                    </div>
                </div>
            </div>
